...
export const clientLogos: AssetReference[] = [
  {
    key: "arco",
    src: "/assets/logos/clients/arco.png",
    alt: "Arco logo",
  ...
  {
    key: "cbre",
    src: "/assets/logos/clients/cbre.svg",
    alt: "CBRE logo",
    usage: ["home marquee", "trust section"],
    beltScale: 0.68,
    beltWidth: 4304,
  ...
  {
    key: "hilton",
    src: "/assets/logos/clients/hilton.png",
    alt: "Hilton logo",
    usage: ["home marquee", "trust section"],
    beltScale: 0.96,
    beltWidth: 378,
  ...
  {
    key: "sevenEleven",
    src: "/assets/logos/clients/7-eleven.svg",
    alt: "7-Eleven logo",
    usage: ["home marquee", "trust section"],
    beltScale: 1,
    beltWidth: 45,
  ...
  {
    key: "pepsi",
    src: "/assets/logos/clients/pepsi.svg",
    alt: "Pepsi logo",
    usage: ["home marquee", "trust section"],
    beltScale: 1.08,
    beltWidth: 212,
